...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-03-2022 a las 14:15:47
...
(11, 'Veronica', 'Diaz', 'San Martín 300', 155383578),
(12, 'Agustin', 'Torres', 'Bv Chacabuco 350', 156358597),
(13, 'Laura', 'Ribulgo', 'Jose Hening 780', 155334272),
(14, 'Agustin', 'Negro', 'Dean Funes 454', 157141559),
(15, 'Joaquin', 'Molina', 'Corrientes 600', 157422712);
...
--
ALTER TABLE `alumnos`
  MODIFY `id_legajo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
COMMIT;
